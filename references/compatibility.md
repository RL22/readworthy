...
| `SKILL.md`          | Markdown required   | Yes                                  | Pair with a `references/skill.html` (or similar) for deeper operational instructions.     | Load tiny SKILL first; HTML only on relevant tasks.               |
